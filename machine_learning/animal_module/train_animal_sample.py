"""
Sample Animal Image Classification using Scikit-learn
=====================================================

This script trains your animal dataset using scikit-learn approaches
on a representative sample to complete training quickly.
"""
...
class SampleAnimalClassifier:
    ...
    def plot_results(self):
        ...
        plt.tight_layout()
        plt.savefig('animal_classification_results_sample.png', dpi=300, bbox_inches='tight')
        plt.show()
    ...
    def save_models(self):
        ...
        for model_name, model in self.models.items():
            model_path = f'models/sample_{model_name.lower().replace(" ", "_")}_animal_classifier.joblib'
    ...
    def train_all_approaches(self):
        ...
        print("=" * 80)
        print("SAMPLE SCIKIT-LEARN ANIMAL IMAGE CLASSIFICATION TRAINING")
        print("=" * 80)
        ...
        plt.tight_layout()
        plt.savefig('confusion_matrix_sample.png', dpi=300, bbox_inches='tight')
        plt.show()
        ...
        print("\n" + "=" * 80)
        print("SAMPLE SCIKIT-LEARN TRAINING COMPLETED!")
        print("=" * 80)
        print("Models have been saved to the 'models/' directory")
        print("Results visualization saved as 'animal_classification_results_sample.png'")
        print("Confusion matrix saved as 'confusion_matrix_sample.png'")
        
        return self.results


def main():
    """Main function to run sample scikit-learn animal image classification training."""
    print("🐾 Starting Sample Scikit-learn Animal Image Classification Training 🐾")
    
    # Initialize the classifier with the new dataset
    classifier = SampleAnimalClassifier(max_samples_per_class=300)  # Reduced sample size for faster training
    
    # Run the complete pipeline
    results = classifier.train_all_approaches()
    
    print("\n🎉 Sample scikit-learn training completed successfully!")
    print("Models have been saved to the 'models/' directory")
